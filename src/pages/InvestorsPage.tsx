  ...
  const benefits = [
    {
      ...
      description: isAr ? 'عوائد سنوية بنسبة 8-15% على الاستثمارات العقارية' : '8-15% annual returns on real estate investments',
    },
    {
      icon: DollarSign,
      title: isAr ? 'سيولة فورية' : 'Instant Liquidity',
      description: isAr ? 'بيع وشراء حصص العقارات على البلوكتشين' : 'Buy and sell property shares on blockchain',
    },
    {
      icon: PieChart,
      title: isAr ? 'محفظة متنوعة' : 'Diversified Portfolio',
      description: isAr ? 'استثمر في عقارات متعددة بحد أدنى للاستثمار' : 'Invest in multiple properties with minimal capital',
    },
    {
      icon: BarChart3,
      title: isAr ? 'تحليلات شفافة' : 'Transparent Analytics',
      description: isAr ? 'تتبع استثماراتك في الوقت الفعلي مع تحليلات الذكاء الاصطناعي' : 'Track your investments in real-time with AI analytics',
    },
  ];
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-2 text-zinc-900 dark:text-white">{benefit.title}</h3>
